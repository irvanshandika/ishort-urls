...
function SignUpPage() {
  ...
  useEffect(() => {
    if (showSuccessAlert) {
      const timer = setTimeout(() => {
        router.push("/auth/signin"); // Navigate after 4 seconds
      }, 4000);
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100">
      {showSuccessAlert && <div className="fixed top-5 bg-green-500 text-white p-4 rounded-lg shadow-lg">Akun Anda Berhasil Sign Up</div>}
        ...
        <div className="mt-10">
          <form onSubmit={handleSignUp}>
            ...
            <div className="flex justify-center items-center mt-4">
              <Button onClick={handleGoogleSignUp} variant="bordered">
                Sign Up with{" "}
