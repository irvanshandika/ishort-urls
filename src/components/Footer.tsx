          ...
          <div className="flex flex-col items-center w-full mt-20 mb-5">
            ...
            <div className="flex flex-col items-center gap-6 mb-8">
              <div className="flex flex-wrap items-center justify-center gap-5 lg:gap-12 gap-y-3 lg:flex-nowrap text-dark-grey-900">
                <Link href="/" className="text-gray-600 hover:text-gray-900" aria-label="Home">
                  Home
                </Link>
                <Link href="/about" className="text-gray-600 hover:text-gray-900" aria-label="About">
                  About
                </Link>
                <Link href="/about" className="text-gray-600 hover:text-gray-900" aria-label="Contact">
                  Contact
                </Link>
              </div>
              <div className="flex items-center gap-8">
                <Link target="_blank" href="https://www.facebook.com/shandika.irvan/" className="text-grey-700 hover:text-grey-900" aria-label="Facebook">
                ...
                <Link target="_blank" href="https://github.com/irvanshandika" className="text-grey-700 hover:text-grey-900" aria-label="Github">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path
                ...
                <Link target="_blank" href="https://www.linkedin.com/in/irvan-shandika/" className="text-grey-700 hover:text-grey-900" aria-label="LinkedIn">
                ...
                <Link target="_blank" href="https://www.instagram.com/irvan_shandika/" className="text-grey-700 hover:text-grey-900" aria-label="Instagram">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
            ...
            <div className="flex items-center">
              <p className="text-base font-normal leading-7 text-center text-grey-700">
                ©{years}{" "}
                <Link href="https://irvans.my.id" className="hover:underline" target="_blank" aria-label="Portfolio">
                  Irvans
                </Link>{" "}
                . All rights reserved.
              </p>
