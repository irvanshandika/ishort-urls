          ...
          <div className="flex flex-col items-center w-full mt-20 mb-5">
            ...
            <div className="flex flex-col items-center gap-6 mb-8">
              ...
              <div className="flex items-center gap-8">
                <Link href="https://www.facebook.com/shandika.irvan/" className="text-grey-700 hover:text-grey-900">
                ...
                <Link href="https://www.linkedin.com/in/muhammad-irvan-shandika/" className="text-grey-700 hover:text-grey-900">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path
                ...
                <Link href="https://github.com/irvanshandika" className="text-grey-700 hover:text-grey-900">
                ...
                <Link href="https://www.instagram.com/irvan_shandika/" className="text-grey-700 hover:text-grey-900">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
            ...
            <div className="flex items-center">
              <p className="text-base font-normal leading-7 text-center text-grey-700">2023 Motion Tailwind CSS Library. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
